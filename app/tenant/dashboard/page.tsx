...
export default function DashboardPage() {
  return (
    <div className="space-y-6">
      <PageHeader title="Tenancy Overview" description="Your lease, rent status, and recent activity." icon={LayoutDashboard} />
      <EmptyState
        icon={LayoutDashboard}
        title="Coming in Phase 3"
        description="Your lease, rent status, and recent activity."
      />
    </div>
  );
}
